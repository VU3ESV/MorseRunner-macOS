...
uses
  ...
  MovAvg, Mixers, VolumCtl, RndFunc, TypInfo, DxStn, DxOper, Log, SdrIntf;
...
begin
  ...
  //(port) tap the wideband received baseband (noise + QRN/QRM + all callers,
  //without the local TX) for the HPSDR SDR-server. No-op unless SdrStart ran.
  SdrPushIq(ReIm.Re, ReIm.Im, Ini.BufSize);
