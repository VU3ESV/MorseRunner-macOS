...
begin
  ...
  //streams to its live truth feed. Cheap append; no effect on the simulation.
  ApiRecordCall(MyCall, Pitch, Wpm, MyCall, Round(BlocksToSeconds(Tst.BlockNumber) * 1000));
